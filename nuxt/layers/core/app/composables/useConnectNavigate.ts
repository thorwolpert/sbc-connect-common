export const useBcrosNavigate = () => {
  ...
  function goToAccountInfo () {
    redirect(config.public.authWebURL + `account/${accountStore.currentAccount.id}/settings/account-info`)
  }
  function goToTeamMembers () {
    redirect(config.public.authWebURL + `account/${accountStore.currentAccount.id}/settings/team-members`)
  }
  function goToTransactions () {
    redirect(config.public.authWebURL + `account/${accountStore.currentAccount.id}/settings/transactions`)
  }
